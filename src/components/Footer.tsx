...
import { fadeIn, staggerChildren } from '@/types/motion';
  ...
  return (
    <footer className=' border-t border-gray-500'>
      <motion.div
        ...
        className='mx-auto'>
        <div className='items-center flex flex-row justify-between py-5 pt-10 container mx-auto'>
          <motion.div
        ...
        <motion.div
          ...
          className='px-4 py-6 bg-gray-500 md:flex md:items-center md:justify-between'>
          <span className='text-sm text-white sm:text-center'>
            © 2023 <a href='https://flowbite.com/'>kubkwel99™</a>. All Rights Reserved.
          </span>
